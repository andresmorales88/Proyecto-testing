...
const garminSchema = z.object({
  ...
  sleep_hours: z.string().nullable().describe("Duracion de sueno, e.g. '7h 21m'"),
  body_battery_am: z.number().nullable().describe("Body Battery cargada/AM, e.g. 61"),
  stress_avg: z.number().nullable().describe("Estres promedio, e.g. 36"),
  steps: z.number().nullable().describe("Pasos del dia, e.g. 15542"),
  kcal_burned: z.number().nullable().describe("Calorias quemadas, e.g. 2491"),
  vfc_7d: z.number().nullable().describe("VFC media 7 dias en ms, e.g. 46"),
})

const eufySchema = z.object({
  weight: z.number().nullable().describe("Peso en kg, e.g. 69.7"),
  body_fat_pct: z.number().nullable().describe("Porcentaje de grasa corporal, e.g. 14.9"),
  muscle_mass: z.number().nullable().describe("Masa muscular en kg, e.g. 56.4"),
  mb_kcal: z.number().nullable().describe("Metabolismo basal en kcal, e.g. 1533"),
})
